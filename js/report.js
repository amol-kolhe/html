  	...
  	$scope.initGrigOptionsCancellation = function(fromdate,tilldate) {
	    ...
	    $scope.gridOptionsCancellationReport = {
		    columnDefs: [
		      ...
		      { field: 'currentPackageName',name:'Current Package',width:'20%' },         
		      { field: 'noOfCancellationInCurPkg',name:'Cancellations In Current Package',width:'15%' },
		      { field: 'freeCancellationRemainCurPkg',name:'Free Cancellations Remain',width:'15%' },		      
		      { field: 'cancellationFeeDeducted',width:'15%' },
